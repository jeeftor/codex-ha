...
If intent is unclear, ask whether they want to draft PR text, run Copilot-rule review, create a new PR, update an existing PR branch, or inspect an existing PR.
