...
- Commit and push updates to an already-open GitHub PR branch: `$ha-pr-update`.
- Multi-PR overview, open PR status table, prioritization, or what to work on next: `$ha-pr-table`.
...
If intent is unclear, ask whether they want to draft PR text, run Copilot-rule review, create a new PR, update an existing PR branch, summarize all open PRs, or inspect one existing PR.
