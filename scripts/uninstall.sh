...
SKILLS="ha-init ha-workflow ha-integration ha-library ha-feature ha-bugfix ha-tests ha-coverage ha-pr ha-pr-writer ha-pr-create ha-pr-update ha-copilot-review ha-pr-watcher ha-sync ha-docs"
remove_skills=""
